...
class AccessService{
  ...
  async updateRole(org,id,data){const result=await this.repository.updateRole(org,id,data);if(result.error==="role")throw new AppError(404,"ROLE_NOT_FOUND","Role not found.");if(result.error==="protected")throw new AppError(422,"ROLE_PROTECTED","Super Admin permissions cannot be reduced.");}
}
