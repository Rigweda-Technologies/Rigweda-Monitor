      ...
      <div className="space-y-6">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Updates automatically every 30 seconds. An employee is active when their agent has reported mouse activity in the last 3 minutes.</p>
          </div>
              ...
              <TableBody>
                {!loading && employees.map((employee) => (
                  <TableRow key={employee.employeeId}>
                    ...
                    <TableCell><Badge className={employee.status === "active" ? "bg-emerald-600 hover:bg-emerald-600" : "bg-slate-500 hover:bg-slate-500"}>{employee.status === "active" ? "Active" : "Offline"}</Badge></TableCell>
