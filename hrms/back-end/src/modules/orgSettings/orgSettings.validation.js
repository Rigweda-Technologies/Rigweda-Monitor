...
exports.upsertOrgSettingsSchema = Joi.object({
  ...
  themeMode: Joi.string().valid("preset", "custom").default("preset"),
  themePreset: Joi.string().valid("ocean", "forest", "sunset", "graphite").default("ocean"),
  themeConfig: Joi.object({
    primary: Joi.string().allow("").default(""),
    secondary: Joi.string().allow("").default(""),
    ...
    muted: Joi.string().allow("").default(""),
    border: Joi.string().allow("").default(""),
    ring: Joi.string().allow("").default("")
  }).default({}),
